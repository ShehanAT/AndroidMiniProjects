...
//                     setState(() => productCalories =
//                         9 * productFat + 4 * productCarbs + 4 * productProtein);
//                   } else {
...
//             await DatabaseService(uid: user.uid).updateScanData(scan.productID,
//                 productCalories, productCarbs, productFat, productProtein);
//             Navigator.pop(context);
//           },
//         ),
//       ),
